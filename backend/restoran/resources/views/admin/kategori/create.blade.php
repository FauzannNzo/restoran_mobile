    ...
    <form action="{{ route('admin.kategoris.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 gap-6">
            <div>
                ...
                <input type="text" name="nama_kategori" required class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 transition" placeholder="Contoh: Makanan Ringan">
            </div>
